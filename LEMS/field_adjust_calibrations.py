...
outputpath = 'C:\\Users\\Jaden\\Documents\\GitHub\\2023_1_24_7_36_22_Recalibrated.csv'
# input header file to be used for the recalculation
headerpath = 'C:\\Users\\Jaden\\Documents\\GitHub\\2023_1_24_7_36_22_Header.csv'
logpath = 'C:\\Users\\Jaden\\Documents\\GitHub\\2023_1_24_7_36_22_log.txt'


##########################################

def field_adjust_calibrations(inputpath, outputpath, headerpath, logpath):
    ...
    [data_new, updated_channels] = RedoFirmwareCalcs(firmware_version, names, A_old, B_old, const_old, data_old, A_new,
                                                     B_new, const_new)
    '''
    ###############################################################

    #bipassing firmware update for now
    updated_channels = names
    data_new = data_old
    ...
    # end of function
    '''
    #Bipassing graphing for now. Data file still outputted


#######################################################################
# run function as executable if not called by another function
if __name__ == "__main__":
    field_adjust_calibrations(inputpath, outputpath, headerpath, logpath)
