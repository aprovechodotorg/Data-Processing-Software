        ...
        for n, fuel in enumerate(fuels): #iterate through all fuels found
            ...
            for phase in phases:
                ...
                try: #fuel dry mass is the fuel mass with moisture content removed
                    ...
                    try:
                        ...
                        log = 'undefined variable: fuel_mass. Check initial and final fuel weight inputs'
                        print(log)
                        logger.error(log)
                        logs.append(line)
                        fval[name] = ''
            ...
            try:
                ...
                try:
                    ...
                    log = 'undefined variable: fuel_Cfrac_db'
                    print(log)
                    logger.error(log)
                    logs.append(log)
                    fval[name] = ''
            ...
            for phase in phases:
                ...
                try:
                    ...
                    try:
                        ...
                        log = 'undefined variable: fuel_mass'
                        print(log)
                        logger.error(log)
                        logs.append(log)
                        fval[name] = ''
            ...
            try:
                ...
                try:
                    ...
                    log = 'undefined variable: fuel_mc'
                    print(log)
                    logger.error(log)
                    logs.append(log)
                    fval[name] = ''
