...
def LEMS_EmissionCalcs_ISO(inputpath,energypath,gravinputpath,aveinputpath,emisoutputpath,alloutputpath,logpath, timespath, versionpath,
        ...
        if os.path.isfile(phaseinputpath): #check that time series path exists
            ...
            for species in emissions:
                ...
                try: #old spreadsheet
                    ...
                    try:
                        pmetric[name] = pmetric[species + '_total_mass'] / euval['fuel_mass_' + phase] * euval['fuel_EHV_' + phase] #Fuel EHV includes char
                    except:
                        pmetric[name]=''
