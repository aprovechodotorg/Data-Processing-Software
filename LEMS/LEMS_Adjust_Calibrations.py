...
def LEMS_Adjust_Calibrations(inputpath, versionpath, outputpath,headerpath,logpath, inputmethod):
    ...
    try:
        ...
        [names,units,data_old,A_old,B_old,C_old,D_old,const_old, version] = io.load_timeseries_with_header(inputpath,logpath)
    ...
    if inputmethod == '1': #Only show in interactive mode
        msgstring=f'Enter sensorbox firmware version. \n\n' \
                  ...
                  f' SB4011, SB4012, SB4013, SB4016, SB4017, SB4018' \
    ...
    if entered_firmware_version == default_firmware_version or '4003' in entered_firmware_version or \
            ...
            or '4012' in entered_firmware_version or '4016' in entered_firmware_version \
            or '4017' in entered_firmware_version or '4018' in entered_firmware_version:
        ...
        LEMS_3001(inputpath, outputpath, logpath)  # If 2041 SB, send to reconfigure script
    elif any(v in entered_firmware_version for v in ['3002', '3009', '3015', '3016']):
       LEMS_300X_Universal(inputpath, outputpath, logpath, entered_firmware_version)
        ...
        line_2 = 'Current supported software versions are: SB4002, SB4003, SB4004, SB4005, SB4007, SB4008, SB4010,' \
                 ' SB4011, SB4012, SB4013, SB4016, SB4017, SB4018, SB2041, SB3001, SB3002, SB3009, SB3015, SB3016, ' \
                 'Possum2.'
        print(line)
        print(line_2)
        logs.append(line)
