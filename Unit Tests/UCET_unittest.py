...
# python -m unittest Unit Tests.UCET_unittest
# or
...
class UCETunittest(unittest.TestCase):
    ...
    def test_L2calcs(self):
        base_path = Path("./Unit Tests/UCET/Gyapa")
    ...
    def test_L3calcs(self):
        base_path = Path("./Unit Tests/UCET")
