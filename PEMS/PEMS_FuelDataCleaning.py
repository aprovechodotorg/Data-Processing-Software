...
# *** TO DO: Add code that finds the time in between removal events and saves these time differences to an array. What
...
def fuel_removal(smooth_data, raw_data, threshold=0.25, merge_threshold=15):
    ...
    for idx in removal_index:
        ...
        removal_timestamp.append((raw_data['time'][idx]))
