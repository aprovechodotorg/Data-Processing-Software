...
# I am using fuel_removal_with_exact to test out verifying fuel loading events against the EXACT data. The fuel_removal
# function works well on its own but only takes into account the FUEL data when determining loading events
...
if __name__ == "__main__":
    ...
    # sheetinputpath = "D:\\School Stuff\\MS Research\\Data\\GP001\\3.16.23_FuelData.csv"
