...
def PEMS_SubtractBkgPitot(inputpath,energyinputpath,ucpath,outputpath,timespath,bkgmethodspath,logpath):
    ...
    bkgnames=['Pitot','CO2hi','PM'] #list of channel names that will get background subtraction. CO2hi and PM are added just for plotting. any changes to these series will not be saved
    ...
    for phase in phases:
        cbphaseoutputpath=cboutputpath[:-4]+'_'+phase+'.csv'    #name the input file by inserting the phase name into cboutputpath
        phaseoutputpath=outputpath[:-4]+'_'+phase+'.csv'    #name the output file by inserting the phase name into outputpath
